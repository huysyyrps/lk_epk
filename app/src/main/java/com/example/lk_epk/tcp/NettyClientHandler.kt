...
/**
 *
 * @FileName:com.safframework.netty4android.client.handler.NettyClientHandler
...
class NettyClientHandler(private val listener: NettyClientListener<String>, private val index: Int, private val isSendheartBeat: Boolean, private val heartBeatData: Any?) : SimpleChannelInboundHandler<String>() {
    ...
    override fun channelActive(ctx: ChannelHandlerContext) {
        ...
        listener.onClientStatusConnectChanged(Constant.STATUS_CONNECT_SUCCESS, index)
    }
    ...
    override fun exceptionCaught(ctx: ChannelHandlerContext, cause: Throwable) {
        ...
        listener.onClientStatusConnectChanged(Constant.STATUS_CONNECT_ERROR, index)
