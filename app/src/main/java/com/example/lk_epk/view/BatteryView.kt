 ...
 */
 class BatteryView constructor(context: Context?, attrs: AttributeSet? = null) : View(context, attrs) {
    ...
    fun BatteryView() {
        ...
        paintPowerBody.strokeWidth = dip2px(2.0f).toFloat()
        ...
        val textSize = Math.round(18.0f * ratioMetrics)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawText(percent .toString(), (width / 3 - dip2px(2.5f)).toFloat(), (height - height * 2 / 5.5).toFloat(), paintText)
    }
